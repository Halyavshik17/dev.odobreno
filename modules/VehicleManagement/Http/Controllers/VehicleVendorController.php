...
use Modules\VehicleManagement\DataTables\VendorDataTable;
...
class VehicleVendorController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware(['auth', 'verified', 'permission:vehicle_vendor_management']);
    ...
    public function index(VendorDataTable $dataTable)
    {
        ...
        return $dataTable->render('vehiclemanagement::vendor.index');
    }
    ...
    {
        return view('vehiclemanagement::vendor.create_edit')->render();
    }
    ...
    {
        return view('vehiclemanagement::vendor.create_edit', ['item' => $vendor])->render();
    }
